...
public class ProfileController {
    ...
    @ResponseBody
    public Profile disableProfile(String profileId,
                                  @RequestParam(value = PARAM_ATTRIBUTE_TO_RETURN, required = false)
                                  String[] attributesToReturn) throws ProfileException {
 ...
 @RequestParam(PARAM_QUERY) String query,
    ...
    public VerificationToken getVerificationToken(
         @PathVariable(PATH_VAR_ID) String tokenId) throws ProfileException {
    ...
    public List<ProfileAttachment> getAttachments(
         @PathVariable(PATH_VAR_ID) String profileId) throws ProfileException, IOException {
        Profile profile = profileService.getProfile(profileId);
        if (profile != null) {
    ...
    @ResponseBody
    public ProfileAttachment getAttachmentDetails( @PathVariable(PATH_VAR_ID) String profileId,
                                                   @PathVariable(PATH_VAR_ATTACHMENT)
