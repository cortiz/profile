...
public class TenantController {
    ...
    @ResponseBody
    public Tenant verifyNewProfiles(
    ...
    @ResponseBody
    public Tenant addAttributeDefinitions(
            @PathVariable(PATH_VAR_NAME) String tenantName,
    ...
    @ResponseBody
    public Tenant updateAttributeDefinitions(
            @PathVariable(PATH_VAR_NAME) String tenantName,
            @RequestBody Collection<AttributeDefinition> attributeDefinitions)
            throws ProfileException {
    ...
    @ResponseBody
    public Tenant removeAttributeDefinitions(
            @PathVariable(PATH_VAR_NAME) String tenantName,
